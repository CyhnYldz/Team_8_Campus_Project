...
@CucumberOptions(
        ...
        features = {"src/test/java/FeatureFiles/T8CP-3_DocumentTypes.feature"},
        glue = {"StepDefinitions"},
        plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)
public class T8CP_3_TestRunner extends AbstractTestNGCucumberTests {
    ...
    public static void writeExtentReport() {
        ...
        ExtentService.getInstance().setSystemInfo("User Name", "Metin CANPOLAT");
